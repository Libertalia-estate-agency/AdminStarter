...
import bg from "@/public/images/auth/gradient2.png"
...
import slider4 from "@/public/images/auth/Libertalia1.png"
import slider5 from "@/public/images/auth/Libertalia2.png"
import slider6 from "@/public/images/auth/background7.jpg"
          ...
          >
            <SwiperSlide>
              <div className="w-full h-full flex justify-center items-center">
                <Image src={slider4} alt="image" className="" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="w-full h-full flex justify-center items-center">
                <Image src={slider5} alt="image" className="" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="w-ful6l h-full flex justify-center items-center">
                <Image src={slider6} alt="image" className="" />
              </div>
            </SwiperSlide>
          </Swiper>
        </div>
