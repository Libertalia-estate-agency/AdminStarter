  ...
  return (
    <div className="w-full">
      <Link href="/dashboard" className="flex justify-center">
        <Logo1 className="h-24 w-24 2xl:w-24 2xl:h-24 text-primary flex justify-center" />
      </Link>
      <div className="2xl:mt-8 mt-6 2xl:text-3xl text-2xl font-bold text-default-900 flex justify-center underline">
        Registration
      </div>
      <div className="2xl:text-lg text-base text-default-600 mt-2 leading-6 flex justify-center">
        Register your account information here
      </div>
