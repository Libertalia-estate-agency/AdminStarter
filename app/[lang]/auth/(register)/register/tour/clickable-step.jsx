...
const ClickableStep = () => {
  ...
  const stepsN = ["Step 1", "Step 2", "Step 3", "Step 4", "Step 5"];
  const steps = ["Personal Details", "Privacy Policy", "Account Verification", "Profile Creation", "Dashboard"];
  ...
  return (
    <div className="mt-4">
      <Stepper current={activeStep} direction={isTablet && "horizontal"} alternativeLabel gap size="xl">
        {steps.map((label, index) => {
          ...
          return (
            <Step key={label} {...stepProps}>
              ...
              <StepDescription >{index}</StepDescription>
            </Step>
          );
        })}
      </Stepper>
