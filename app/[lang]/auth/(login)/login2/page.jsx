...
import background1 from "@/public/images/auth/gradient2.png";
    ...
    <>
      <div className="min-h-screen bg-background  flex items-center  overflow-hidden w-full">
        <div className="min-h-screen basis-full flex flex-wrap w-full  justify-center overflow-y-auto">
          <div
            className="basis-1/2 bg-amber w-full  relative hidden xl:flex justify-center items-center bg-gradient-to-br
      ...
      <Dialog open={openVideo}>
        <DialogContent size="lg" className="p-0" hideCloseIcon>
          ...
          <iframe
            width="100%"
            height="315"
            src="https://www.youtube.com/embed/qzU19p5hwR8"
            title="YouTube video player"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowFullScreen
            sandbox="allow-autoplay allow-clipboard-write allow-encrypted-media allow-forms allow-same-origin allow-scripts"
          ></iframe>
        </DialogContent>
      </Dialog>
    </>
