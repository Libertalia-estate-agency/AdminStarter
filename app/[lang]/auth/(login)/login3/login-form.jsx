  ...
  return (
    <div className="w-full py-2">
      <Link href="/dashboard" className="flex justify-center">
        <Logo4 className="h-28 w-28 2xl:h-28 2xl:w-28 text-primary" />
      </Link>
      <div className="2xl:mt-4 mt-4 2xl:text-3xl text-2xl font-bold text-default-900">
        Welcome 👋
      </div>
      ...
      <div className="mt-6 text-center text-base text-default-600">
        ...
        <Link href="/auth/register3" className="text-warning">
          Register {" "}
        </Link>
      </div>
    </div>
